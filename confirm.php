	...
	if(isset($usn) && isset($passkey))
	{
		...
		else
		{
			...
			if($rows==1)
			{
				...
				if($validation==0)
				{
					$query1 = mysql_query("UPDATE pass SET activated=1 WHERE usn='$usn' and pass_key='$passkey'") or die("Cannot execute queery1");
					$_SESSION['message']="Your account has been activated. Please login <a href=\"index.php\">here</a>.";
				}
				else if($validation==1)
				{
					$_SESSION['message']='Your account has already been activated.';
				}
			...
			{
				$_SESSION['message']='Invalid USN.<br>';
				echo $usn."<br>";
				echo $passkey;
				die();
			}
