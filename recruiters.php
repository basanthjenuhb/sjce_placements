...
<head>
	...
	<meta charset="utf-8">
	<title>SJCE</title>
	<link rel="stylesheet" href="styles/recruiters1.css">
</head>
<body>
	<div id="bigwrapper">
		<header id="header_">
		...
		<section id="section_">
			...
			<div id="nav_10">
			<ul>
				<a href="#opendream"><li id="li_1">open dream companies</li></a>
				<a href="#dream"><li id="li_2">dream companies</li></a>
				<a href="#core"><li id="li_3">core companies</li></a>
				<a href="#mass"><li id="li_4">mass companies</li></a>
			</ul>
			</div>
			<table>
				<tr>
