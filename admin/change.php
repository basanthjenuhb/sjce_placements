<?php
	...
	$pquery1=mysql_query("SELECT pass_word FROM pass WHERE usn LIKE '{$_SESSION['admin']}'");
	if(!$pquery1 || mysql_num_rows($pquery1)!=1)
				...
				else
				{
					...
					if(isset($_POST['pass2']) && !empty($_POST['pass2']) && $_POST['pass2']!='')
					{
						...
						else if($_POST['pass1']==$_POST['pass2'])
						{
							...
							{
								$pquery2=mysql_query("UPDATE pass SET `pass_word` ='{$_POST['pass2']}' WHERE `usn` ='{$_SESSION['admin']}'");
								if($pquery2)
